...
| 패턴 | 적용 대상 | 래퍼 클래스 |
|---|---|---|
| **A — 단일 스크롤** | PoC 대시보드 | `flex-1 overflow-x-hidden overflow-y-auto p-4` |
| **B — 전체 너비 도구** | i18n, 전체 폭 테이블 | `flex-1 overflow-auto px-4 py-3` |
| **C — 패널 분할** | tms/main, farm (사이드바+메인) | `flex flex-1 overflow-hidden p-3 gap-3` |
