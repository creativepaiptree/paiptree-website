    ...
    >
      <div className="container mx-auto px-1 lg:px-6">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Platform 1 - /0.1 */}
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-16 p-8 transition-colors duration-300 hover:bg-gray-200 border-t border-gray-300">
