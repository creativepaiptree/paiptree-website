  ...
  return NextResponse.json(
    {
      ...
      farmScopeStateCount: result.persistResult.farmScopeStateCount ?? 0,
      farmScopeEventCount: result.persistResult.farmScopeEventCount ?? 0,
      farmScopeMessage: result.persistResult.farmScopeMessage,
      summary: result.persistResult.summary ?? result.payload.summary,
    },
